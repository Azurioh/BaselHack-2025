  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <ThemedView style={styles.stepContainer}>
        ...
        <ThemedText>
          Edit <ThemedText type="defaultSemiBold">app/index.tsx</ThemedText> to see changes. Press{' '}
      ...
      <ThemedView style={styles.stepContainer}>
        ...
        <ThemedText>You can add more pages by creating new .tsx files in the app/ directory.</ThemedText>
      </ThemedView>
      <ThemedView style={styles.stepContainer}>
